                      ...
                      {media.canConfirmSuggestion ? (
                        <div className="flex shrink-0 gap-2">
                          <button
                            ...
                            className="min-h-10 px-3 text-xs font-medium text-zinc-400 hover:text-white disabled:opacity-50"
                          >
                            Dismiss
                          </button>
                          <button
                            ...
                            className="min-h-10 rounded-lg bg-zinc-100 px-3 text-xs font-semibold text-zinc-950 disabled:opacity-50"
                          >
                            Yes
                          </button>
                        </div>
